...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2021 at 12:03 PM
...
(1, 'oussama', '202cb962ac59075b964b07152d234b70', 1, 'oussama@academycode.com'),
(2, 'anas', '202cb962ac59075b964b07152d234b70', 1, 'anas@academycode.com'),
(3, 'hassan', '202cb962ac59075b964b07152d234b70', 0, 'hassan@academycode.com'),
(4, 'Ali', '202cb962ac59075b964b07152d234b70', 0, 'ali@academycode.com'),
(5, 'SALHI', '202cb962ac59075b964b07152d234b70', 0, 'salhi@academycode.com'),
(6, 'ilyas', '202cb962ac59075b964b07152d234b70', 0, 'ilyas@academycode.com'),
(7, 'farouk', '202cb962ac59075b964b07152d234b70', 0, 'farouk@academycode.com'),
(8, 'steve', '202cb962ac59075b964b07152d234b70', 0, 'steve@academycode.com'),
(9, 'sara', '202cb962ac59075b964b07152d234b70', 0, ''),
(10, 'fadoua', '202cb962ac59075b964b07152d234b70', 0, 'fadoua@academycode.com'),
(11, 'mariam', '202cb962ac59075b964b07152d234b70', 0, 'mariam@academycode.com'),
(13, 'chafik', '202cb962ac59075b964b07152d234b70', 0, 'chafik@academycode.com'),
(14, 'khadija', '202cb962ac59075b964b07152d234b70', 0, 'khadija@academycode.com'),
(15, 'sir', '202cb962ac59075b964b07152d234b70', 0, 'sir@academycode.com'),
(16, 'jilali', '202cb962ac59075b964b07152d234b70', 0, 'jilali@academycode.com'),
(17, 'khalid', '202cb962ac59075b964b07152d234b70', 0, 'khalid@academycode.com'),
(18, 'azzouz', '202cb962ac59075b964b07152d234b70', 0, 'azzouz@academycode.com');
...
--
ALTER TABLE `absence`
  ADD CONSTRAINT `FK_etudiant1` FOREIGN KEY (`fk_etudiant`) REFERENCES `etudiant` (`id_etudiant`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_seance` FOREIGN KEY (`fk_seance`) REFERENCES `seance` (`id_seance`) ON DELETE CASCADE;

--
-- Constraints for table `enseignant`
--
ALTER TABLE `enseignant`
  ADD CONSTRAINT `FK_ens` FOREIGN KEY (`fk_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE;

--
-- Constraints for table `etudiant`
--
ALTER TABLE `etudiant`
  ADD CONSTRAINT `FK_etu` FOREIGN KEY (`fk_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE;

--
-- Constraints for table `module`
--
ALTER TABLE `module`
  ADD CONSTRAINT `FK_Enseigne_module` FOREIGN KEY (`fk_enseigne`) REFERENCES `enseignant` (`id_enseignant`) ON DELETE CASCADE;

--
-- Constraints for table `note`
--
ALTER TABLE `note`
  ADD CONSTRAINT `FK_Etudiant2` FOREIGN KEY (`fk_etudiant`) REFERENCES `etudiant` (`id_etudiant`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_Module1` FOREIGN KEY (`fk_module`) REFERENCES `module` (`id_module`) ON DELETE CASCADE;

--
-- Constraints for table `seance`
--
ALTER TABLE `seance`
  ADD CONSTRAINT `FK__seance_enseignant` FOREIGN KEY (`fk_seance_enseignant`) REFERENCES `enseignant` (`id_enseignant`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK__seance_module` FOREIGN KEY (`fk_seance_module`) REFERENCES `module` (`id_module`) ON DELETE CASCADE;
COMMIT;
